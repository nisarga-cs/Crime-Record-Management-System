...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
 ...
 <div class="row">
      <div class="card" id="card1">
        <h3>Dashboard</h3>
        <p class="text">
          Analyse crime records, total number of cases alloted to you<br />total number
          of cops
        </p>
      ...
      <div class="card" id="card2">
        ...
        <a class="btn btn-primary" href="./operations/crime_home.php" role="button">Edit</a>
      </div>
      </div>
      <div class="card" id="class4">
        <h3>Your Profile</h3>
        <p>View your profile</p>
        <a class="btn btn-primary" href="./operations/user_profile.php" role="button">View</a>
      </div>
    </div>
</body>
</html>