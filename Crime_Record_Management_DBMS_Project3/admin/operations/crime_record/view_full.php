    ...
    <div>
      <form class="form" action="edit_sql.php">
        ...
        <select
          name="selectoption"
          class="form-control"
          id="exampleFormControlSelect1"  required disabled
       ...
       <?php
        ...
        <input class="form-control" type="text" placeholder="Criminal name" name="criminal_name" value="<?php echo $criminal_name; ?>" required readonly/>
        <label>Location at which crime took place:</label>

        <input class="form-control" type="text" placeholder="Location" name="location" value="<?php echo $location; ?>" required readonly/>
        <label>Year at which crime took place:</label>
        <input class="form-control" type="text" placeholder="Year" name="year" value="<?php echo $year; ?>" readonly/>
        ...
        <input class="form-control" type="tel" value="<?php echo $victim_phone; ?>" placeholder="Enter 10 dight phone number" name="victim_phone" pattern="[789][0-9]{9}" required readonly/>
        <label>Location of victim:</label>
        <input class="form-control" type="text" value="<?php echo $victim_location; ?>" placeholder="Location" name="victim_location" required readonly/>
        ...
        <select
          ...
          value="<?php echo $case_status; ?>"  required disabled
        >
